...
public class DiagData
{
    ...
    public static readonly DiagData Empty = new();
    public static bool FullTimeMode = true;        

    public virtual string GetLogHeader()
    {
        return
            "TIME,TRT,RPM,RPM40,RPM_GBC_RT,UFRXX,SSM,TWAT,TAIR,ALF,AFR," +
            "ALF_LC1,AFR_LC1,COEFF,DGTC_RICH,DGTC_LEAN,UOZ,KUOZ1,KUOZ2,KUOZ3," +
            "KUOZ4,FAZ,INJ,FUSE,AIR,GBC,SPD,ADCKNOCK,ADCMAF,ADCTWAT,ADCTAIR,ADCTPS," +
            "ADCUBAT,ADCLAM,Err,fSTOP,fXX,fXXPrev,fXXFix,fPOW,fFUELOFF,fDETZONE,fDET," +
            "fADS,fLAMREG,fLAM,fLEARN,fLAMRDY,fLAMHEAT";
    }
    ...
    [Browsable(false)]
    public DateTime _Time => new(Time.Ticks);
    ...
    [Browsable(false)]
    public bool IsErrorFound => ErrorCount != 0 || ErrorStatus != 0;
    ...
    public virtual string GetValue(string name)
    {
        ...
        return name switch
        {
            ...
            "UOZ" => UOZ.ToString("0.#", CultureInfo.InvariantCulture),
            "DUOZ" => j7EsDiagData != null ? j7EsDiagData.DUOZ.ToString("0.#", CultureInfo.InvariantCulture) : "-",
            "TRT" => TRT.ToString(CultureInfo.InvariantCulture),
            "TWAT" => TWAT.ToString(CultureInfo.InvariantCulture),
            "TAIR" => TAIR.ToString(CultureInfo.InvariantCulture),
            "ALF" => ALF.ToString("0.##", CultureInfo.InvariantCulture),
            "LC1_ALF" => LC1_ALF.ToString("0.##", CultureInfo.InvariantCulture),
            "COEFF" => COEFF.ToString("0.###", CultureInfo.InvariantCulture),
            "INJ" => INJ.ToString("0.###", CultureInfo.InvariantCulture),
            "FUSE" => FUSE.ToString("0.#", CultureInfo.InvariantCulture),
            "AIR" => AIR.ToString("0", CultureInfo.InvariantCulture),
            "GBC" => GBC.ToString("0", CultureInfo.InvariantCulture),
            "SPD" => SPD.ToString(CultureInfo.InvariantCulture),
            "Press" => j7EsDiagData != null ? j7EsDiagData.Press.ToString("0.##", CultureInfo.InvariantCulture) : "-",
            "TARGET_BOOST" => j7EsDiagData != null
                ? j7EsDiagData.TARGET_BOOST.ToString("0.##", CultureInfo.InvariantCulture)
                : "-",
            "WGDC" => j7EsDiagData != null ? j7EsDiagData.WGDC.ToString(CultureInfo.InvariantCulture) : "-",
            "TURBO_DYNAMICS" => j7EsDiagData != null
                ? j7EsDiagData.TURBO_DYNAMICS.ToString(CultureInfo.InvariantCulture)
                : "-",
            "UGB_RXX" => j7EsDiagData != null
                ? j7EsDiagData.UGB_RXX.ToString("0.##", CultureInfo.InvariantCulture)
                : "-",
            _ => string.Empty
        };
    }
